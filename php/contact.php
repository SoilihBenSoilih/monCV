<?php
    ...
    { 
        ...
        if (empty($array["email"])) {
			$array["emailError"] = "Veuillez saisir un email de contact!";
			$isSuccess=false;
		}
        else if(!isEmail($array["email"])) 
        {
            $array["emailError"] = "Vérifier le format de votre email!";
            $array["isSuccess"] = false; 
        } 
        else
        {
